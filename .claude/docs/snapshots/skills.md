...
* [Choose where skills load](#where-skills-live)
  + [Load skills in monorepos and subdirectories](#discovery-from-parent-and-nested-directories)
  + [Load skills from a directory outside the project](#skills-from-additional-directories)
  + [Resolve skills that share a name](#resolve-skills-that-share-a-name)
  + [Use skills in Cowork and cloud sessions](#skills-in-cowork-and-cloud-sessions)
  ...
  + [Edit a skill during a session](#live-change-detection)
...
* [Advanced patterns](#advanced-patterns)
  ...
  + [Permission checks on injected commands](#permission-checks-on-injected-commands)
